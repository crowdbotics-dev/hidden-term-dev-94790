"""
Django settings for hidden_term_dev_94790 project.
...
ROOT_URLCONF = 'hidden_term_dev_94790.urls'
...
WSGI_APPLICATION = 'hidden_term_dev_94790.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_term_dev_94790 API",
    "DESCRIPTION": "API documentation for hidden_term_dev_94790 App",
    "VERSION": "v1",
}
